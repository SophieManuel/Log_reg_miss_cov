...
```{r}
dfbeta1 <- data.frame("Estimateur"= as.numeric(c(EST.comp[,2], EST.cc[,2], EST.saem[,2])), "meth" = as.factor( c(rep("comp",nbsim), rep("cc",nbsim), rep("saem",nbsim))), "alea"= as.factor(rep(EST.comp[,5],3))) # dernière colonne du tableau pour créer l'indicatrice MCAR/MAR
```
